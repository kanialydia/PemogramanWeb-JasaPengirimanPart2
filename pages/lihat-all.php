	...
	<div id="wrapper">	
	 <!-- Navigation -->
        ...
        <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Data Lengkap Anggota</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>             
			...
			<div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                Berikut adalah daftar Anggota yang telah terdaftar
                            </div>
