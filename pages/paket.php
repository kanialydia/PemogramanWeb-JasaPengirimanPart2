                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="index-kurir.php"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                            </li>
							<li>
                                <a href="paket.php"><i class="fa fa-edit fa-fw"></i> Paket Perlu Dikirim</a>
                            </li>
			...
			<div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                Berikut adalah daftar seluruh paket yang perlu dikirim
                            </div>
							...
							$q="SELECT * FROM paket WHERE status='proses' ";
							$hasil=@mysqli_query ($dbkoneksi, $q);// menjalankan query 
								...
								if($hasil){
                                    ...
                                    echo '
                                        ...
                                        echo'<tr>
												<td><a href="kirim.php?packetID=' . $baris['packetID'] . '">
												<button type="button" class="btn btn-outline btn-primary btn-xs  btn-info">Kirim Paket</button></a></td>
												<td>' . $baris['resi'] . '</td>
                                                <td>' . $baris['sender'] . '</td>
