...
<html lang="en">
	...
	<div id="wrapper">			
        <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Hapus Rekaman</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div> 
				<?php
