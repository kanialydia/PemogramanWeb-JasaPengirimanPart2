                ...
                <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <nav class="navbar navbar-expand-lg navbar-dark bg-danger navbar-fixed-top" role="navigation">
								...
								<div  id = "slider">
								  <img src="logo/k5.png" width= "1300" />
								</div>
					...
					<div class="panel panel-danger">
								...
								<div class="col-lg-6">
									<div class="well well-lg">
										<h1>VISI</h1>
										<p>Menjadikan Perusahaan Pengiriman Barang Tercepat Dan Terdepan Di Dalam Maupun Ke Luar Negeri.</p>
								...
								<div class="col-lg-6">
									<div class="well well-lg">
										...
										<p>-	Memberikan Pengalaman terbaik kepada konsumen dalam hal pengiriman</p>
											...
											<p>-	Menjadi perusahaan terbaik dan terbesar di bidang pengiraman barang baik di dalam negeri dan luar negeri
											</p>
									</div>
								</div>
								<!-- /.col-lg-12 -->
