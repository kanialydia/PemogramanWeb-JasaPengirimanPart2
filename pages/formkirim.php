        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <ul class="nav navbar-nav navbar-left navbar-top-links">
                    <li><a href="index-user.php"><i class="fa fa-home fa-fw"></i> Express</a></li>
                </ul>
                ...
                <ul class="nav navbar-right navbar-top-links">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li><a href="passuser.php"><i class="fa fa-gear fa-fw"></i> Change your password</a>
                            </li>
                            <li class="divider"></li>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="ongkiruser.php"><i class="fa fa-table fa-fw"></i> Cek Ongkir</a>
                            </li>
                            <li>
			...
			include "kon.php";
				...
				if($_SERVER['REQUEST_METHOD']=='POST'){
					...
					//apakah sudah level
					if(empty($_POST['fee'])){
						$arrayError[]='<script type="text/javascript">alert("Ongkir tidak boleh kosong");</script> ';
					}
					...
					if(empty($arrayError)){
						...
						VALUES('','$resi','$pengirim','$addka','$adds','$nopm',NOW(),'$penerima','$addkt','$addr','$nopa','','$ket','$barang','$berat','$jumlah','$fee','proses' )";
						$hasil = @mysqli_query ($dbkoneksi, $q);//menjalankan query
						
						if($hasil){//jika berhasil
						echo'Paket berhasil diproses ';
                ...
                <!-- /.row -->
				<form action="formkirim.php" method="post">
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <div class="panel-body">
										...
										<h3 class="page-header ">Data Pengirim</h3>
											...
											<div class="form-group input-group">
                                                ...
                                                <input class="form-control" for="fee"  placeholder="Fee" autofocus 
											id="fee" type="number" name="fee" 
											value="<?php if (isset($_POST['fee'])) echo $_POST['fee']; ?>">
											...
											<input id="submit" 
											type="submit" name="submit" class="btn btn-outline btn-success btn-lg btn-block" value="Kirim Paket">
